...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter) {
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from customers where meternumber = '"+meter+"'");
            while(rs.next()) {
                ...
                meternumber.setText(rs.getString("meternumber"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                Conn c = new Conn();
                c.s.executeUpdate("update customers set address = '"+address+"', city = '"+city+"', state = '"+state+"', email = '"+email+"', phone = '"+phone+"' where meternumber= '"+meter+"'");
