...
public class CalculateBill extends JFrame implements ActionListener{
    ...
    CalculateBill() {
        ...
        try {
            ...
            while(rs.next()) {
                meternumber.add(rs.getString("meternumber"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from customers where meternumber = '"+meternumber.getSelectedItem()+"'");
            while(rs.next()) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            int totalbill = unit_consumed * 10;
